...
int main(int argc, char** argv){
    ...
    argparse::Subparser* subparser_1 = parser.add_subparsers(NULL, NULL, NULL, NULL, NULL, false, "help of subparser 1", NULL);
    ...
    argparse::Subparser* subparser_2 = parser.add_subparsers(NULL, NULL, NULL, NULL, NULL, false, NULL, NULL);
