...
int main(int argc, char** argv){
    ...
    int choices1[2] = {1, 2};
    parser.add_argument("-a --argument-a", NULL, 3, 0, 2, "int", 2, choices1, false, "first argument", "metavar", NULL, 0);
    const char* choices2[2] = {"choice_1", "choice_2"};
    parser.add_argument("-b --argument-b", "store", 3, "cst", "def1", "string", 2, choices2, false, "second argument", "metavar", NULL, 0);
    parser.add_argument("-c --argument-c", "store", 3, (float) 2.1, (float) 1.9, "float", 0, NULL, false, "third argument", "metavar", NULL, 0);
