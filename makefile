...
example_1:update argparse.o
	...
	g++ ./obj/example_1.o ./obj/argparse.o -L ./bin -l deallocator -o ./bin/example_1

example_2:update argparse.o
	g++ -c ./examples/example_2.cpp -o ./obj/example_2.o
	g++ ./obj/example_2.o ./obj/argparse.o -L ./bin -l deallocator -o ./bin/example_2

example_3:update argparse.o
	g++ -c ./examples/example_3.cpp -o ./obj/example_3.o
	g++ ./obj/example_3.o ./obj/argparse.o -L ./bin -l deallocator -o ./bin/example_3
